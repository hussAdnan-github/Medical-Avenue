...
import { whyUs } from "@/mocks/clinicData";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-3xl overflow-hidden border border-brand-cream-200" style={{ height: "500px" }}>
              <img
                src="https://readdy.ai/api/search-image?query=precision%20medicine%20doctor%20reviewing%20advanced%20diagnostic%20data%20DNA%20genomics%20screens%20modern%20sophisticated%20clinical%20environment%20dark%20teal%20professional%20medical%20science&width=700&height=550&seq=whyus-ma1&orientation=landscape"
          ...
          <div className="order-1 lg:order-2">
            <span className="inline-block bg-brand-forest-100 text-brand-forest-700 text-xs font-semibold px-4 py-1.5 rounded-full mb-4">
              لماذا ذا مديكال أفينيو؟
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4 leading-tight">
              طب أعمق، أكثر تخصيصًا،
              <span className="text-brand-forest-600"> ومدعوم بالدقة</span>
            </h2>
            <p className="text-gray-500 text-base leading-relaxed mb-3">
              نحن لسنا عيادة أسرع — بل عيادة أعمق. نفكك الحالة ونقرأ ما وراء العرض، ونربط بين الحاضر الصحي والمخاطر المستقبلية.
            </p>
            <p className="text-gray-400 text-sm leading-relaxed mb-8">
              كل مريض يملك بيولوجيا ومسارًا صحيًا مختلفًا. لذلك نصمم لكل حالة خطة مبنية على تقييمها الفعلي، لا على بروتوكول عام.
            </p>
