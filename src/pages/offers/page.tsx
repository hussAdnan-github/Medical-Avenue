...
const seasonalOffers: SeasonalOffer[] = [
  {
    ...
    image: "https://readdy.ai/api/search-image?query=beautiful%20crescent%20moon%20and%20stars%20with%20golden%20light%20rays%20on%20dark%20night%20sky%20background%2C%20elegant%20Islamic%20geometric%20patterns%2C%20warm%20amber%20and%20gold%20tones%2C%20minimalist%20artistic%20style%2C%20health%20and%20wellness%20concept&width=800&height=400&seq=offer-ramadan&orientation=landscape",
  },
  {
    id: "summer",
    ...
    textColor: "text-brand-forest-700",
    accentColor: "teal",
    icon: "ri-sun-line",
    ...
    image: "https://readdy.ai/api/search-image?query=bright%20sunny%20summer%20day%20with%20tropical%20leaves%20and%20flowers%2C%20vibrant%20teal%20and%20cyan%20colors%2C%20fresh%20healthy%20lifestyle%20concept%2C%20clean%20minimal%20background%20with%20sunlight%20rays%2C%20modern%20medical%20wellness%20aesthetic&width=800&height=400&seq=offer-summer&orientation=landscape",
  },
  {
    id: "national",
    ...
    image: "https://readdy.ai/api/search-image?query=Saudi%20Arabia%20national%20day%20celebration%20with%20green%20and%20white%20colors%2C%20palm%20trees%20and%20desert%20landscape%2C%20patriotic%20elegant%20design%2C%20clean%20modern%20background%20with%20geometric%20patterns%2C%20health%20and%20wellness%20theme&width=800&height=400&seq=offer-national&orientation=landscape",
  },
  {
    id: "winter",
    ...
    image: "https://readdy.ai/api/search-image?query=winter%20wellness%20concept%20with%20snowflakes%20and%20ice%20crystals%20on%20clean%20white%20background%2C%20cool%20blue%20and%20silver%20tones%2C%20health%20prevention%20theme%2C%20minimal%20modern%20design%20with%20geometric%20snowflake%20patterns&width=800&height=400&seq=offer-winter&orientation=landscape",
  },
];
...
const flashDeals: FlashDeal[] = [
  { packageId: "check-executive", flashDiscount: 35, endsIn: 48, label: "عرض محدود" },
  { packageId: "vip-executive", flashDiscount: 40, endsIn: 24, label: "فلاش سيل" },
  { packageId: "family-standard", flashDiscount: 30, endsIn: 72, label: "عرض العائلة" },
  { packageId: "cardio-premium", flashDiscount: 28, endsIn: 36, label: "عرض القلب" },
];
    ...
    <section className="mb-16">
      ...
      <div className={`relative rounded-2xl overflow-hidden bg-gradient-to-r ${offer.bgGradient} mb-6`}>
        <div className="absolute inset-0 opacity-20">
          <img src={offer.image} alt={offer.title} className="w-full h-full object-cover object-top" />
        </div>
...
export default function OffersPage() {
  const [activeFilter, setActiveFilter] = useState<"all" | "ramadan" | "summer" | "national" | "winter">("all");

  const filteredOffers = activeFilter === "all"
    ? seasonalOffers
    : seasonalOffers.filter((o) => o.id === activeFilter);

  // Nearest ending offer for hero countdown
  const nearestOffer = seasonalOffers.reduce((prev, curr) =>
    ...
    <div dir="rtl" className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="relative pt-28 pb-0 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 pb-16 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight">
            عروض موسمية لا تُفوَّت
          </h1>
          <p className="text-white/80 text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
            خصومات حصرية تصل إلى 40% على أفضل باقاتنا الطبية. استثمر في صحتك بأقل تكلفة.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto mb-10">
            {[
              ...
              { icon: "ri-percent-line", value: "40%", label: "أعلى نسبة خصم" },
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {[
              ...
              { id: "ramadan", label: "رمضان", icon: "ri-moon-line" },
              { id: "summer", label: "الصيف", icon: "ri-sun-line" },
              { id: "national", label: "اليوم الوطني", icon: "ri-flag-line" },
              { id: "winter", label: "الشتاء", icon: "ri-snowy-line" },
            ].map((tab) => (
              <button
                key={tab.id}
      ...
      <section className="bg-white py-14">
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { step: "01", icon: "ri-search-eye-line", title: "اختر الباقة", desc: "تصفح العروض واختر الباقة المناسبة لك" },
              { step: "02", icon: "ri-calendar-check-line", title: "احجز موعدك", desc: "اضغط على زر الحجز وحدد الوقت المناسب" },
              { step: "03", icon: "ri-coupon-line", title: "السعر المخفض تلقائياً", desc: "يُطبَّق الخصم تلقائياً بدون كود" },
              { step: "04", icon: "ri-hospital-line", title: "احضر وتمتع", desc: "احضر في موعدك واستمتع بالخدمة بالسعر المخفض" },
            ].map((item) => (
      ...
      <section className="py-14 bg-gradient-to-r from-brand-forest-700 to-brand-forest-600">
        <div className="max-w-3xl mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="text-2xl font-black text-white mb-3">لا تفوّت أي عرض قادم!</h2>
          <p className="text-brand-cream-200 text-sm mb-7 max-w-md mx-auto">
            سجّل رقمك وسنُرسل لك إشعاراً فور إطلاق أي عرض جديد أو تخفيض حصري
          </p>
