...
import { aboutValues } from "@/mocks/clinicData";
...
function Stagger({ children, baseDelay = 0, step = 90 }: {
  children: React.ReactNode[];
  baseDelay?: number;
  step?: number;
}) {
  return (
    <>
      {children.map((child, i) => (
        <Reveal key={i} delay={baseDelay + i * step} direction="up">
          {child}
        </Reveal>
      ))}
    </>
...
───────────────────────────────────────────── */
const milestones = [
  { year: "2018", title: "التأسيس", desc: "انطلقت ذا مديكال أفينيو برؤية واضحة: تقديم طب أعمق وأكثر تخصيصًا للحالات التي تحتاج أكثر من بروتوكول علاجي عام." },
  { year: "2019", title: "إطلاق DNA Risk Score", desc: "أصبحنا من أوائل المنصات في المنطقة التي تقدم تحليل DNA Risk Score كأداة سريرية حقيقية لا استعراضية." },
  { year: "2021", title: "الامتداد الدولي", desc: "بناء شبكة علاقات وخبرات دولية في الولايات المتحدة وجنوب كوريا لتقديم Second Opinion منظم للحالات المعقدة." },
  { year: "2022", title: "منصة الطب الأيضي", desc: "إطلاق برنامج متخصص للسمنة والخلل الأيضي وMASLD — نتعامل مع الحالة كمسار أيضي ووظيفي معقد." },
  { year: "2023", title: "تطبيق المراقبة الصحية", desc: "إطلاق تطبيق المتابعة اللصيقة لربط المريض بمؤشرات حالته الصحية بشكل مستمر." },
  { year: "2026", title: "اليوم", desc: "أكثر من 30 استشاري متخصص، وآلاف الحالات التي حصلت على فهم حقيقي وخطة شخصية مبنية على بيولوجيتها الخاصة." },
];

const teamMembers = [
  { name: "د. فيصل الأحمد", role: "المدير الطبي", experience: "18 سنة", image: "https://readdy.ai/api/search-image?query=professional%20male%20arab%20doctor%20white%20coat%20stethoscope%20clean%20cream%20background%20confident%20authoritative%20portrait%20precision%20medicine%20specialist%20senior&width=400&height=500&seq=team-ma1&orientation=portrait" },
  { name: "د. سارة المنصور", role: "رئيسة قسم الطب الأيضي", experience: "14 سنة", image: "https://readdy.ai/api/search-image?query=professional%20female%20arab%20doctor%20white%20coat%20hijab%20clean%20cream%20background%20confident%20smile%20portrait%20metabolic%20medicine%20specialist&width=400&height=500&seq=team-ma2&orientation=portrait" },
  { name: "د. خالد العمر", role: "رئيس قسم الطب النفسي", experience: "16 سنة", image: "https://readdy.ai/api/search-image?query=professional%20male%20arab%20doctor%20white%20coat%20glasses%20clean%20cream%20background%20confident%20smile%20portrait%20psychiatrist%20specialist%20senior&width=400&height=500&seq=team-ma3&orientation=portrait" },
  { name: "د. نورة الزهراني", role: "رئيسة قسم الجينات", experience: "12 سنة", image: "https://readdy.ai/api/search-image?query=professional%20female%20arab%20doctor%20white%20coat%20clean%20cream%20background%20friendly%20confident%20portrait%20genetics%20precision%20medicine%20specialist&width=400&height=500&seq=team-ma4&orientation=portrait" },
  { name: "د. محمد الراشد", role: "استشاري هشاشة العظام", experience: "15 سنة", image: "https://readdy.ai/api/search-image?query=professional%20male%20arab%20doctor%20white%20coat%20clean%20cream%20background%20confident%20smile%20portrait%20orthopedic%20bone%20specialist%20senior&width=400&height=500&seq=team-ma5&orientation=portrait" },
  { name: "د. ريم الحربي", role: "استشارية العلاجات الوريدية", experience: "10 سنوات", image: "https://readdy.ai/api/search-image?query=professional%20female%20arab%20doctor%20white%20coat%20hijab%20clean%20cream%20background%20confident%20smile%20portrait%20IV%20therapy%20specialist%20medical%20professional&width=400&height=500&seq=team-ma6&orientation=portrait" },
];

const awards = [
  { icon: "ri-trophy-line",      title: "منصة الطب الدقيق الأولى",  body: "تصنيف مستقل 2024" },
  { icon: "ri-global-line",      title: "شراكة دولية معتمدة",       body: "مراكز USA وجنوب كوريا" },
  { icon: "ri-dna-line",         title: "رائدة DNA Risk Score",      body: "أول تطبيق سريري في المنطقة" },
  { icon: "ri-shield-star-line", title: "معتمدة من هيئة الصحة",     body: "المملكة العربية السعودية" },
];
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "680px" }}>
        <div className="absolute inset-0">
          <img
            src="https://readdy.ai/api/search-image?query=calm%20bright%20modern%20medical%20clinic%20interior%20natural%20daylight%20soft%20white%20walls%20warm%20cream%20tones%20clean%20minimal%20hallway%20plants%20peaceful%20serene%20healthcare%20environment%20airy%20spacious%20wide%20panoramic&width=1440&height=720&seq=about-ma-hero-calm-v1&orientation=landscape"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Reveal direction="right" duration={800}>
              <div className="relative">
                <div className="rounded-3xl overflow-hidden border border-brand-cream-200" style={{ height: "500px" }}>
                  <img
                    src="https://readdy.ai/api/search-image?query=precision%20medicine%20team%20doctors%20reviewing%20advanced%20diagnostic%20data%20DNA%20genomics%20screens%20modern%20sophisticated%20clinical%20environment%20professional%20medical%20science%20collaboration%20warm%20forest%20green%20tones&width=700&height=550&seq=about-ma-story-v2&orientation=landscape"
                    alt="قصتنا"
                    className="w-full h-full object-cover object-top"
                  />
                </div>
                <Reveal direction="up" delay={300}>
                  <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-5 border border-brand-cream-200 w-52">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-black text-gray-900 text-xl">2018</p>
                ...
                <Reveal direction="down" delay={400}>
                  <div className="absolute -top-5 -right-5 bg-brand-forest-800 rounded-2xl p-4 text-white text-center w-36">
                    <p className="text-2xl font-black text-brand-cream-200">+30</p>
            ...
            <Reveal direction="left" delay={150} duration={800}>
              <div>
                <span className="inline-block bg-brand-forest-100 text-brand-forest-700 text-xs font-semibold px-4 py-1.5 rounded-full mb-5">قصتنا</span>
                <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-6 leading-tight">
                  من سؤال بسيط
                  <span className="text-brand-forest-600"> إلى منصة طب دقيق</span>
                </h2>
                <p className="text-gray-500 text-base leading-relaxed mb-4">
                  بدأت ذا مديكال أفينيو من سؤال حقيقي: لماذا يخرج كثير من المرضى من الزيارات الطبية دون صورة واضحة؟ لماذا تُختزل الحالات المعقدة في بروتوكولات عامة؟
                </p>
                <p className="text-gray-500 text-base leading-relaxed mb-4">
                  الإجابة كانت واضحة: الطب التقليدي يعمل بسرعة، لكن بعض الحالات تحتاج عمقًا. فأسسنا منصة تقوم على التقييم العميق، الأدوات الدقيقة، والامتداد الدولي.
                </p>
                <p className="text-gray-500 text-base leading-relaxed mb-8">
                  اليوم، نخدم المرضى الذين يحتاجون أكثر من استشارة تقليدية — من خلال جلسات 90–120 دقيقة، تقنيات DNA، وشبكة خبرات دولية في USA وكوريا.
                </p>
                <div className="flex flex-wrap gap-3">
                  {[
                    { Shape: StarShape, text: "DNA Risk Score" },
                    { Shape: LotusShape, text: "Second Opinion دولي" },
                    { Shape: SunShape, text: "جلسات 90–120 دقيقة" },
                  ].map(({ Shape, text }, i) => (
                    <Reveal key={i} direction="scale" delay={300 + i * 80}>
                      <div className="flex items-center gap-2 bg-brand-cream-100 border border-brand-cream-200 px-4 py-2 rounded-full">
                        ...
                        <span className="text-sm text-brand-forest-800 font-medium">{text}</span>
                      </div>
                    </Reveal>
                  ))}
                </div>
      ...
      <section className="py-20 bg-brand-cream-50">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                Shape: StarShape, dark: false,
                title: "رسالتنا",
                body: "تقديم طب أعمق وأكثر تخصيصًا للمرضى الذين يحتاجون أكثر من استشارة تقليدية — من خلال التقييم العميق، الفحوصات الدقيقة، وقراءة المخاطر المستقبلية.",
              },
              {
                Shape: SunShape, dark: true,
                title: "رؤيتنا",
                body: "أن نكون المرجع الأول في المنطقة للطب الدقيق والرعاية التخصصية المتقدمة — نموذجًا يُحتذى به في تقديم رعاية تقوم على الفهم قبل القرار.",
              },
              {
                Shape: LotusShape, dark: false,
                title: "فلسفتنا",
                body: "كل مريض يملك بيولوجيا ومسارًا صحيًا مختلفًا. نفهم قبل أن نقرر، نحلل قبل أن نتدخل، ونستجيب قبل أن نطارد.",
              },
            ].map(({ Shape, dark, title, body }, i) => (
              <Reveal key={i} direction="scale" delay={i * 120} duration={700}>
                <div className={`rounded-3xl p-8 h-full relative overflow-hidden transition-all duration-300 hover:-translate-y-1 ${dark ? "bg-brand-forest-800" : "bg-white border border-brand-cream-200 hover:border-brand-forest-200"}`}>
                  {dark && <div className="absolute top-0 right-0 left-0 h-0.5 bg-gradient-to-r from-transparent via-brand-cream-300/40 to-transparent" />}
                  <div className={`w-14 h-14 flex items-center justify-center rounded-2xl mb-5 ${dark ? "bg-brand-cream-300/15" : "bg-brand-cream-100"}`}>
                    <Shape size={30} color={dark ? "rgba(227,218,201,0.95)" : "#2E4E45"} />
                  </div>
                  <h3 className={`text-xl font-black mb-3 ${dark ? "text-white" : "text-gray-900"}`}>{title}</h3>
                  <p className={`leading-relaxed text-sm ${dark ? "text-brand-cream-200/75" : "text-gray-500"}`}>{body}</p>
                </div>
              </Reveal>
            ))}
          </div>
                ...
                <div className={`${dim.bg} rounded-3xl p-8 text-white h-full relative overflow-hidden group hover:-translate-y-1.5 transition-transform duration-300`}>
                  ...
                  <ul className="space-y-3">
                    {dim.items.map((item, j) => (
                      <li
                        key={j}
                        className="flex items-center gap-2.5 text-sm text-brand-cream-200/80"
                        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {aboutValues.map((val, i) => (
              <Reveal key={i} direction="scale" delay={i * 90} duration={650}>
      ...
      <section className="py-20 bg-brand-cream-50">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {awards.map((award, i) => (
              <Reveal key={i} direction="up" delay={i * 100} duration={650}>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
            {teamMembers.map((member, i) => (
              <Reveal key={i} direction="up" delay={i * 70} duration={600}>
...
/* ─────────────────────────────────────────────
   Sub-components (kept outside main to avoid re-renders)
───────────────────────────────────────────── */
    ...
    <div className="max-w-2xl pt-28 pb-16">
      ...
      <div style={{ opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(24px)", transition: "opacity 750ms ease 350ms, transform 750ms ease 350ms" }}>
        <h1 className="text-4xl md:text-6xl font-black text-white mb-5 leading-tight">
          ...
          <span className="block text-brand-cream-300 mt-1 text-3xl md:text-4xl min-h-[1.3em]">
            <TypewriterText
              words={["منصة الطب الدقيق", "عمق سريري حقيقي", "رعاية بلا حدود", "نفهم قبل أن نقرر"]}
              typeSpeed={65}
              deleteSpeed={38}
              pauseAfter={2500}
              startDelay={1200}
      ...
      <div style={{ opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(20px)", transition: "opacity 700ms ease 500ms, transform 700ms ease 500ms" }}>
        <p className="text-white/75 text-base md:text-lg leading-relaxed mb-3 max-w-xl">
          لسنا عيادة تقليدية محسّنة — بل نموذج طبي متقدم يجمع بين الدقة، العمق، والتواصل العالمي لخدمة الحالات التي تحتاج أكثر من المعتاد.
        </p>
      ...
      >
        <Link
          to="/booking"
          className="inline-flex items-center gap-2 bg-brand-cream-300 text-brand-forest-900 font-bold px-7 py-3.5 rounded-full hover:bg-brand-cream-200 transition-colors whitespace-nowrap cursor-pointer"
        >
        ...
        <Link
          to="/doctors"
          className="inline-flex items-center gap-2 border-2 border-brand-cream-300/40 text-brand-cream-200 font-semibold px-7 py-3.5 rounded-full hover:bg-brand-cream-300/10 transition-colors whitespace-nowrap cursor-pointer"
        >
          تعرف على استشاريينا
    ...
    <section ref={ref} className="py-20 bg-brand-forest-800 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-8 text-center">
        ...
        >
          <Link
            to="/booking"
            className="inline-flex items-center justify-center gap-2 bg-brand-cream-300 text-brand-forest-900 font-bold px-8 py-4 rounded-full hover:bg-brand-cream-200 transition-colors whitespace-nowrap cursor-pointer"
          >
            <i className="ri-calendar-check-line" />
            احجز جلسة تقييم
          </Link>
          <Link
            to="/contact"
            className="inline-flex items-center justify-center gap-2 border-2 border-brand-cream-300/30 text-brand-cream-200 font-semibold px-8 py-4 rounded-full hover:bg-brand-cream-300/10 transition-colors whitespace-nowrap cursor-pointer"
          >
